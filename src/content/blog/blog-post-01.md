---
slug: "blog-post-01"
title: "Template 01 — Replace with your H1 title"
seoTitle: "Template 01 Title"       # ≤44 chars — appears in <title>
keyword: "anahtar kelime 01"
volume: 320
kdi: 28
...
featuredImage:
  src: "/blog-images/placeholder-01.jpg"
...
sections:
  - heading: "İlk Bölüm Başlığı (H2)"
    ...
    bullets:
      ...
      - "Madde 2"
      - "Madde 3"
  - heading: "İkinci Bölüm — Karşılaştırma Tablosu"
    paragraphs:
  ...
  - heading: "Dördüncü Bölüm — Inline Görselli"
    ...
    image:
      src: "/blog-images/placeholder-diagram.jpg"
...
1. Rename this file to your desired slug (e.g., petek-temizligi-fiyati-2026.md).
2. Update the `slug:` field in the YAML above to match the filename.
3. Replace all placeholder values with your researched content.
4. Save. The post will appear at /blog/<slug>.
